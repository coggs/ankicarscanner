...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("au.com.coggs.anki", Context.MODE_PRIVATE);
        ...
        if (requestCode == BARCODE_READER_REQUEST_CODE) {
            if (resultCode == CommonStatusCodes.SUCCESS) {
                if (data != null) {
                    ...
                    carId = barcode.displayValue;
                    JSON_URL =  getString(R.string.ankiCarURL)+ carId;
    ...
    private void setUI(JSONObject itemObject) {
        ...
        groupId = itemObject.getString("groupid");
    ...
    public void moreData(View view) {
        ...
        Intent i = new Intent(getApplicationContext(), moreDataActivity.class);
        groupId = sharedPreferences.getString("groupid", "");
        i.putExtra("anki",groupId);
        startActivity(i);
    }
}
